...
namespace LinqTutorials
{
    public static class LinqTasks
    {
        ...
        private static object maxSalary;
        ...
        {
            int result = dbContext.Emps.Max(e => e.Salary);
        ...
        {
            IEnumerable<Emp> result = dbContext.Emps.Where(e => e.Salary == maxSalary);
            return result;
        }
        ...
        {
            IEnumerable<object> result = dbContext.Emps;
            .Select(e => new { Nazwisko = e.ename, Praca = e.job });
            return result;
        }

        private static void Select(Func<object, object> value)
        {
